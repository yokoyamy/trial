...
const STORAGE_KEY = 'oshigoto_fusen_board_v9_week_template_setting';
    ...
    // sandbox環境でlocalStorageが使えない場合のメモリ退避用ストア
    ...
    const safeStorage = {
        ...
        setItem: function(key, val) {
            try {
                ...
                // SecurityError発生時はメモリストアに退避
            }
            memoryFallbackStorage[key] = String(val);
        }
    };
    ...
    function defaultMembers() {
        return [
            { id: 'tanaka', name: '[last_name]' },
            { id: 'sato', name: '[last_name]' },
            { id: 'suzuki', name: '[last_name]' },
            { id: 'kato', name: '[last_name]' },
            { id: 'yamada', name: '[last_name]' }
        ];
    }
